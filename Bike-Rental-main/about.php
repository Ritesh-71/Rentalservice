    ...
    <section class="team">
        <div class="wrapper-team">
            ...
            <div class="card_container">
                <div class="card">
                    <div class="imbBx">
                        <img src="./user_area/user_images/piyush.jpg" alt="" class="img-team">
                    </div>
                    <div class="content-team">
                        <div class="contentBx">
                            <h3 class="h3-team">Piyush Maharjan <br> <p style="font-size:10px;">Web Analyst</p></h3>
                        </div>
                        <ul class="sci">
                            <li class="li-team" style="--i: 1"><a class="a-team" href="https://www.instagram.com/wa_sabi_man/"><i class="fa-brands fa-instagram"></i></a></li>
                            <li class="li-team" style="--i: 2"><a class="a-team" href="https://www.facebook.com/piyush.maharjan.969"><i class="fa-brands fa-facebook"></i></a></li>
                ...
                <div class="card">
                    <div class="imbBx">
                        <img src="./user_area/user_images/ritesh.jpg" alt="" class="img-team">
                    </div>
                    <div class="content-team">
                        <div class="contentBx">
                            <h3 class="h3-team">Ritesh Khadka <br> <p style="font-size:10px;">Web Analyst</p></h3>
                        </div>
                        <ul class="sci">
                            <li class="li-team" style="--i: 1"><a class="a-team" href="https://www.instagram.com/fjdofhs/"><i class="fa-brands fa-instagram"></i></a></li>
                            <li class="li-team" style="--i: 2"><a class="a-team" href="https://facebook.com/khadka.ritesh.1"><i class="fa-brands fa-facebook"></i></a></li>
                            <li class="li-team" style="--i: 3"><a class="a-team" href="#"><i class="fa-brands fa-twitter"></i></a></li>
                        </ul>
                    </div>
                </div>
